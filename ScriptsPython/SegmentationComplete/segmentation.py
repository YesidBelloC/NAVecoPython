...
#Chemin
os.chdir('C:/Users/crybelloceferin/Documents/MATLAB/Supun/ScriptsPython/SegmentationComplete')
...
seg_slope_sample = 1.5 #en degrees
seg_slope_sample = (seg_slope_sample*2*math.pi)/360
...
data = loadCsv("dataResol1_GMaps_64KmRvarVitR1")
data = data[1:]
...
if(seg_slope):
    ...
    for i in range(1,len(data)):
        ...
        if (abs(float(slope_temp)-ref_slope)>=seg_slope_sample):
            ...
            print('Difference: ')
            print(abs(float(slope_temp)-ref_slope))
            print('Distance: ')
            print(data[i][3])
            print('--------------------------------------------------')
